...
- [qwen3_guest_simpler_w5_pr_changes.md](qwen3_guest_simpler_w5_pr_changes.md)
  - summarizes the Qwen3 guest simpler W5 PR file changes, framework touch points, and default-behavior boundaries
