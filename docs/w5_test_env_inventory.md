...
`guest-linux/aarch64/scripts/run_w5_cluster_config.sh --print-env <config.env>` 是当前
W5 入口的环境面审计命令。入口必须显式传入 config 文件，不再隐式读取
`guest-linux/aarch64/out/w5_cluster_run.env`。输出按以下分组：
...
`run_w5_cluster_config.sh` 会拒绝以下旧变量，并要求改用对应的新变量：

| 旧变量 | 新变量 |
| --- | --- |
| `SIM_W5_MEMORY_RUNTIME_BOUNDARY_LOOKUP` | `SIM_W5_TEST_MEMORY_RUNTIME_BOUNDARY_LOOKUP` |
| `SIM_W5_MEMORY_ONLINE_BOUNDARY_LOOKUP` | `SIM_W5_TEST_MEMORY_ONLINE_BOUNDARY_LOOKUP` |
| `SIM_W5_MEMORY_DECISION_STORE` | `SIM_W5_TEST_MEMORY_DECISION_STORE` |
| `SIM_W5_MEMORY_DECISION_OBJECT_STORE` | `SIM_W5_TEST_MEMORY_DECISION_OBJECT_STORE` |
| `SIM_W5_MEMORY_OBSERVATION_STORE` | `SIM_W5_TEST_MEMORY_OBSERVATION_STORE` |
| `SIM_W5_MEMORY_BOUNDARY_OBSERVATION_ID` | `SIM_W5_TEST_MEMORY_BOUNDARY_OBSERVATION_ID` |
| `SIM_W5_MEMORY_BOUNDARY_OBSERVATION_IDS` | `SIM_W5_TEST_MEMORY_BOUNDARY_OBSERVATION_IDS` |
| `SIM_W5_MEMORY_BOUNDARY_OBSERVATION_RUN_ID` | `SIM_W5_TEST_MEMORY_BOUNDARY_OBSERVATION_RUN_ID` |
| `SIM_W5_MEMORY_SHORTPATH_DECISION_ID` | `SIM_W5_TEST_MEMORY_SHORTPATH_DECISION_ID` |
| `SIM_W5_MEMORY_SHORTPATH_DECISION_IDS` | `SIM_W5_TEST_MEMORY_SHORTPATH_DECISION_IDS` |
| `SIM_W5_MEMORY_SHORTPATH_EXECUTE` | `SIM_W5_TEST_MEMORY_SHORTPATH_EXECUTE` |
| `SIM_W5_MEMORY_PREFIX_CACHE_LOOKUP` | `SIM_W5_TEST_MEMORY_PREFIX_CACHE_LOOKUP` |
| `SIM_W5_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID` | `SIM_W5_TEST_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID` |
| `SIM_W5_MEMORY_PREFIX_CACHE_SERVICE_ADDR` | `SIM_W5_TEST_MEMORY_PREFIX_CACHE_SERVICE_ADDR` |
| `SIM_W5_MEMORY_POST_RUN_PROMOTE` | `SIM_W5_TEST_MEMORY_POST_RUN_PROMOTE` |
| `SIM_W5_MEMORY_PREFETCH_PLAN_ID` | `SIM_W5_TEST_MEMORY_PREFETCH_PLAN_ID` |
| `SIM_W5_MEMORY_GSVA_KV` | `SIM_W5_TEST_MEMORY_GSVA_KV` |
| `SIM_W5_MEMORY_GSVA_EXPECTED_EPOCH` | `SIM_W5_TEST_MEMORY_GSVA_EXPECTED_EPOCH` |
