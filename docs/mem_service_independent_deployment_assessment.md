...
8. 定义 checkpoint record retention、global record retention 和对应 orphan payload block GC；按 kind/TTL/tenant 分层 retention 策略仍需后续补齐。
