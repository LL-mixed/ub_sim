...
Latest active UB Link remote token revoke evidence:

```text
run_id=guest-linux/aarch64/logs/2026-06-09_04-15-17_gsva_coh_17695
command=GSVA_MODE=arm_mmu GSVA_STRICT=1 GSVA_COH_HOLD_PENDING=1 GSVA_COH_UB_LINK_TX=1 GSVA_COH_TIMEOUT_MS=10000 GSVA_TEST_MODE=coh_remote_token_revoke ./guest-linux/aarch64/scripts/run_ub_two_node_gsva_coh_test.sh
nodeA_guest.log: coh_remote_token_revoke ARM MMU touch va=0x700007400000 value=0
nodeA_guest.log: coh_remote_token_revoke New token error=0
nodeA_guest.log: verdict=PASS
nodeB_guest.log: verdict=PASS
nodeA_qemu.log: GSVA_ROUTE: token revoke pending segment_id=0x1 token_id=96 lease_epoch=2
nodeA_qemu.log: GSVA_COH: tx TOKEN_REVOKE target=50386 segment_id=0x1 token_id=96 rc=0
nodeB_qemu.log: GSVA_COH: ub_link rx sub=15 op=11 scna=0xc4c2 payload_len=120
nodeB_qemu.log: GSVA_COH: rx TOKEN_REVOKE from cna=50370 segment_id=0x1 seq=0
nodeA_qemu.log: GSVA_COH: ub_link rx sub=15 op=12 scna=0xc4d2 payload_len=120
nodeA_qemu.log: GSVA_ROUTE: token revoke ack segment_id=0x1 token_id=96 cna=50386 lease_epoch=2
nodeA_qemu.log: GSVA_COH: rx TOKEN_ACK applied from cna=50386 segment_id=0x1 token_id=96 rc=0
...
```text
run_id=guest-linux/aarch64/logs/2026-06-09_04-02-26_gsva_coh_24145
command=GSVA_MODE=arm_mmu GSVA_STRICT=1 GSVA_COH_HOLD_PENDING=1 GSVA_COH_UB_LINK_TX=1 GSVA_COH_TIMEOUT_MS=10000 GSVA_TEST_MODE=coh_remote_retire ./guest-linux/aarch64/scripts/run_ub_two_node_gsva_coh_test.sh
nodeA_guest.log: coh_remote_retire ARM MMU touch va=0x700007000000 value=0
nodeA_guest.log: coh_remote_retire Query already retired peer_cna=50386
nodeA_guest.log: coh_remote_retire Retry error=0
nodeA_guest.log: verdict=PASS
nodeB_guest.log: verdict=PASS
nodeA_qemu.log: GSVA_COH: tx RETIRE target=50386 seq=2 segment_id=0x1 rc=0
nodeB_qemu.log: GSVA_COH: ub_link rx sub=15 op=9 scna=0xc4c2 payload_len=120
nodeB_qemu.log: GSVA_COH: rx RETIRE from cna=50370 segment_id=0x1 seq=2
nodeA_qemu.log: GSVA_COH: ub_link rx sub=15 op=10 scna=0xc4d2 payload_len=120
nodeA_qemu.log: GSVA_COH: RetireAck recovery retire requester=50370 seq=2 segment_id=0x1
