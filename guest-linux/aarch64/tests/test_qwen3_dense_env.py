...
class Qwen3DenseEnvTest(unittest.TestCase):
    ...
    def test_eight_node_runner_passes_decode_round_barrier_timeout(self):
        ...
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_TABLE_REF", runner_text)
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_INDICES_REF", runner_text)
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_GATE_WEIGHT_REF", runner_text)
        ...
        self.assertIn("context op requires object refs", runner_text)
        ...
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_TABLE_REF", launcher_text)
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_STATE_REF", launcher_text)
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_INDICES_REF", launcher_text)
        self.assertIn("SIM_QWEN3_GUEST_ENGRAM_CONTEXT_GATE_WEIGHT_REF", launcher_text)
