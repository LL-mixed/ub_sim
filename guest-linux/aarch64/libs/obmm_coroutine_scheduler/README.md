...
- `obmm_coroutine_scheduler.c` owns the EL0 context store, ready/wait/fault state, round-robin
  policy, completion commit, and `/dev/linqu-async-load0` control ioctls.
