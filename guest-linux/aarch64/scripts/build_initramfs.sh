...
OBMM_TEST_APP_SRC="$ROOT_DIR/apps/obmm_test/obmm_test.c"
OBMM_TEST_APP_BIN="$OUT_DIR/linqu_obmm_test"
...
LINGQU_SHMEM_MEM_SERVICE_SRC="$ROOT_DIR/libs/lingqu_shmem_pto/lingqu_shmem_mem_service.c"
LINGQU_SHMEM_MEM_SERVICE_OBMM_SRC="$ROOT_DIR/libs/lingqu_shmem_pto/lingqu_shmem_mem_service_obmm.c"
QWEN3_PTO_GUEST_SRC="$ROOT_DIR/libs/lingqu_shmem_pto/qwen3_pto_guest.c"
...
MEM_SERVICE_MODEL_DECODE_BARRIER_SRC="$MEM_SERVICE_ROOT/components/mem_service/mem_service_model_decode_barrier.c"
MEM_SERVICE_MODEL_RANGE_KV_STATE_FLOW_SRC="$MEM_SERVICE_ROOT/components/mem_service/mem_service_model_range_kv_state_flow.c"
MEM_SERVICE_MODEL_TERMINAL_TOKEN_FLOW_SRC="$MEM_SERVICE_ROOT/components/mem_service/mem_service_model_terminal_token_flow.c"
MEM_SERVICE_MODEL_RANGE_WAIT_FLOW_SRC="$MEM_SERVICE_ROOT/components/mem_service/mem_service_model_range_wait_flow.c"
MEM_SERVICE_MODEL_RANGE_PUBLISH_FLOW_SRC="$MEM_SERVICE_ROOT/components/mem_service/mem_service_model_range_publish_flow.c"
...
SERVING_CONTROL_APP_BIN="$OUT_DIR/linqu_w5_serving_control"
PRETRAINING_CLIENT_APP_BIN="$OUT_DIR/linqu_pretraining_client"
...
current_initramfs_signature() {
  ...
  write_signature_line "obmm_test_app_src" "$OBMM_TEST_APP_SRC"
  ...
  write_signature_line \
    ...
    "$LINGQU_SHMEM_PTO_DIRECT_ENDPOINT_SRC"
  write_signature_line \
    "lingqu_shmem_mem_service_src" \
    "$LINGQU_SHMEM_MEM_SERVICE_SRC"
  write_signature_line \
    "lingqu_shmem_mem_service_obmm_src" \
    "$LINGQU_SHMEM_MEM_SERVICE_OBMM_SRC"
  for applet in "$ROOT_DIR"/libs/lingqu_shmem_pto/*.h(N); do
    write_signature_line "lingqu_shmem_pto_header" "$applet"
  done
  write_signature_line "qwen3_pto_guest_src" "$QWEN3_PTO_GUEST_SRC"
  ...
  write_signature_line "serving_control_app_src" "$SERVING_CONTROL_APP_SRC"
  write_signature_line "pretraining_client_app_src" "$PRETRAINING_CLIENT_APP_SRC"
  ...
  write_signature_line "mem_service_gsva_access_hdr" "$MEM_SERVICE_GSVA_ACCESS_HDR"
  ...
  write_signature_line "mem_service_model_decode_barrier_src" "$MEM_SERVICE_MODEL_DECODE_BARRIER_SRC"
  write_signature_line "mem_service_model_range_kv_state_flow_src" "$MEM_SERVICE_MODEL_RANGE_KV_STATE_FLOW_SRC"
  write_signature_line "mem_service_model_terminal_token_flow_src" "$MEM_SERVICE_MODEL_TERMINAL_TOKEN_FLOW_SRC"
  write_signature_line "mem_service_model_range_wait_flow_src" "$MEM_SERVICE_MODEL_RANGE_WAIT_FLOW_SRC"
  write_signature_line "mem_service_model_range_publish_flow_src" "$MEM_SERVICE_MODEL_RANGE_PUBLISH_FLOW_SRC"
  write_signature_line "mem_service_qwen3_engram_publish_flow_src" "$MEM_SERVICE_QWEN3_ENGRAM_PUBLISH_FLOW_SRC"
  write_signature_line "mem_service_qwen3_engram_wait_flow_src" "$MEM_SERVICE_QWEN3_ENGRAM_WAIT_FLOW_SRC"
  ...
  write_signature_line "libobmm_src" "$OBMM_SUBMODULE_DIR/src/libobmm/libobmm.c"
  write_signature_line "obmm_vendor_adaptor_sim_src" "$ROOT_DIR/common/obmm_vendor_adaptor_sim.c"
  for applet in "$ROOT_DIR"/common/*.h(N); do
    write_signature_line "common_header" "$applet"
  done
...
build_w5_guest_link_check() {
  ...
  local qwen3_flow_sources=(
    ...
    "$MEM_SERVICE_MODEL_DECODE_BARRIER_SRC"
    "$MEM_SERVICE_MODEL_RANGE_KV_STATE_FLOW_SRC"
    "$MEM_SERVICE_MODEL_TERMINAL_TOKEN_FLOW_SRC"
  ...
  "$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra \
    "${common_include_args[@]}" \
    "${llm_infer_pto_include_args[@]}" \
    ${=LIBOBMM_CFLAGS} \
    "$LLM_INFER_APP_SRC" \
    "${common_mem_service_sources[@]}" \
    "${qwen3_flow_sources[@]}" \
    "$LLM_INFER_SRC" \
    "${llm_infer_pto_sources[@]}" \
    ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} \
...
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$OBMM_TEST_APP_SRC" ${=LIBOBMM_SRCS} -o "$OBMM_TEST_APP_BIN"
...
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/kernel_ub/include/uapi" -I"$ROOT_DIR/common" -I"$ROOT_DIR/apps/obmm_queue" ${=LIBOBMM_CFLAGS} "$OBMM_IMPORT_STRESS_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$OBMM_IMPORT_STRESS_BIN"
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/kernel_ub/include/uapi" -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$OBMM_DATAPLANE_MICROBENCH_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$OBMM_DATAPLANE_MICROBENCH_BIN"
...
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$OBMM_COH_TEST_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$OBMM_COH_TEST_BIN"
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/kernel_ub/include/uapi" -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$GSVA_QUERY_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$GSVA_QUERY_BIN"
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$GSVA_COH_TEST_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$GSVA_COH_TEST_BIN"
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$GSVA_LIFECYCLE_TEST_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$GSVA_LIFECYCLE_TEST_BIN"
...
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$NPU_GSVA_TEST_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$NPU_GSVA_TEST_BIN"
"$AARCH64_LINUX_CC" -static -O2 -Wall -Wextra -I"$ROOT_DIR/common" ${=LIBOBMM_CFLAGS} "$SSD_GSVA_TEST_SRC" ${=LIBOBMM_SRCS} ${=LIBOBMM_LDLIBS} -o "$SSD_GSVA_TEST_BIN"
...
cp "$OBMM_TEST_APP_BIN" "$INITRAMFS_DIR/bin/linqu_obmm_test"
...
cp "$PRETRAINING_CLIENT_APP_BIN" "$INITRAMFS_DIR/bin/linqu_pretraining_client"
chmod +x \
  ...
  "$INITRAMFS_DIR/bin/linqu_pretraining_client" \
