...
export OBMM_GSVA_MODE="${OBMM_GSVA_MODE:-identity}"
export OBMM_GSVA_BASE="${OBMM_GSVA_BASE:-0x700000000000}"
export OBMM_GSVA_SIZE="${OBMM_GSVA_SIZE:-0x400000}"
export OBMM_GSVA_NODE_COUNT="${OBMM_GSVA_NODE_COUNT:-2}"
