...
# OBMM GSVA Matrix Test - Four Node
# Runs the OBMM GSVA app in matrix mode as a formal acceptance test.
...
export OBMM_GSVA_MATRIX_NODE_COUNT="${OBMM_GSVA_MATRIX_NODE_COUNT:-${GSVA_DEMO_NODE_COUNT:-4}}"
