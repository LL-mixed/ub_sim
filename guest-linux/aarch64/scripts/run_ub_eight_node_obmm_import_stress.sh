...
OBMM_MEMSEG_SIZE=2097152
STRESS_SIZE="${STRESS_SIZE:-$OBMM_MEMSEG_SIZE}"
...
if (( STRESS_SIZE % OBMM_MEMSEG_SIZE != 0 )); then
  echo "STRESS_SIZE must be aligned to ${OBMM_MEMSEG_SIZE} bytes: $STRESS_SIZE" >&2
  exit 2
fi
