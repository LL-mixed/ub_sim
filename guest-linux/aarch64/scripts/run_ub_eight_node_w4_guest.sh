...
SIM_W5_MEMORY_SHORTPATH_ARTIFACT_ID="${SIM_W5_MEMORY_SHORTPATH_ARTIFACT_ID:-}"
SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_START="${SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_START:-}"
SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_END="${SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_END:-}"
...
SIM_W5_MEMORY_PREFETCH_ARTIFACT_IDS="${SIM_W5_MEMORY_PREFETCH_ARTIFACT_IDS:-}"
SIM_W5_MEMORY_PREFETCH_ARTIFACT_CHECKSUMS="${SIM_W5_MEMORY_PREFETCH_ARTIFACT_CHECKSUMS:-}"
SIM_W5_MEMORY_PREFETCH_ARTIFACT_REFS="${SIM_W5_MEMORY_PREFETCH_ARTIFACT_REFS:-}"
SIM_W5_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID="${SIM_W5_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID:-}"
SIM_W5_MEMORY_PREFIX_CACHE_ACTION="${SIM_W5_MEMORY_PREFIX_CACHE_ACTION:-}"
SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_ID="${SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_ID:-}"
...
if [ -n "${SIM_UAPI_W5_PROFILE:-}" ]; then
  export SIM_W4_DB_LAZY_REMOTE_ACTIVATION=0
else
  export SIM_W4_DB_LAZY_REMOTE_ACTIVATION="${SIM_W4_DB_LAZY_REMOTE_ACTIVATION:-1}"
fi
...
export SIM_W5_MEMORY_SHORTPATH_ARTIFACT_ID="$SIM_W5_MEMORY_SHORTPATH_ARTIFACT_ID"
export SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_START="$SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_START"
export SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_END="$SIM_W5_MEMORY_SHORTPATH_TARGET_LAYER_END"
...
export SIM_W5_MEMORY_SHORTPATH_PROOF_CHECKSUM="$SIM_W5_MEMORY_SHORTPATH_PROOF_CHECKSUM"
...
export SIM_W5_MEMORY_PREFETCH_CHECKSUM="$SIM_W5_MEMORY_PREFETCH_CHECKSUM"
export SIM_W5_MEMORY_PREFETCH_ARTIFACT_IDS="$SIM_W5_MEMORY_PREFETCH_ARTIFACT_IDS"
export SIM_W5_MEMORY_PREFETCH_ARTIFACT_CHECKSUMS="$SIM_W5_MEMORY_PREFETCH_ARTIFACT_CHECKSUMS"
export SIM_W5_MEMORY_PREFETCH_ARTIFACT_REFS="$SIM_W5_MEMORY_PREFETCH_ARTIFACT_REFS"
export SIM_W5_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID="$SIM_W5_MEMORY_PREFIX_CACHE_REUSE_PLAN_ID"
export SIM_W5_MEMORY_PREFIX_CACHE_ACTION="$SIM_W5_MEMORY_PREFIX_CACHE_ACTION"
export SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_ID="$SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_ID"
export SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_CHECKSUM="$SIM_W5_MEMORY_PREFIX_CACHE_ARTIFACT_CHECKSUM"
...
validate_node_log() {
  ...
  if is_qwen3_dense_profile "$SIM_UAPI_W4_CHIPBACKEND_PROFILE"; then
    assert_log_has "$log_file" "\\[w4_guest\\] stage obmm_cluster_runtime_bootstrap local=node${idx} nodes=8 backing=obmm_pool metadata=lingqu_object_service queue=obmm_spsc status=ok" "$node_id explicit obmm cluster runtime bootstrap" || return 1
  fi
