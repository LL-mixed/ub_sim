...
SIM_W5_MEMORY_PREFIX_CACHE_MATCHED_TOKENS="${SIM_W5_MEMORY_PREFIX_CACHE_MATCHED_TOKENS:-}"
SIM_W5_MEMORY_PREFIX_CACHE_REPLAY_SUFFIX_TOKENS="${SIM_W5_MEMORY_PREFIX_CACHE_REPLAY_SUFFIX_TOKENS:-}"
...
export SIM_W5_MEMORY_PREFIX_CACHE_MATCHED_TOKENS="$SIM_W5_MEMORY_PREFIX_CACHE_MATCHED_TOKENS"
export SIM_W5_MEMORY_PREFIX_CACHE_REPLAY_SUFFIX_TOKENS="$SIM_W5_MEMORY_PREFIX_CACHE_REPLAY_SUFFIX_TOKENS"
