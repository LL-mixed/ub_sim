#!/bin/bash
# M1 entity runtime injection guide.
# Shows how to use an entity plan file with the QEMU launch scripts.
...
echo "=== M1: entity runtime injection guide ==="
echo
echo "当前实现状态:"
echo "1. 启动时可加载 entity plan 文件 (UB_FM_ENTITY_PLAN_FILE)"
echo "2. entity plan 文件定义每个实体的 state (present/absent)"
echo "3. QEMU 启动时根据 plan 注入 UB_DEV_REG 消息到 guest"
echo
echo "使用方法:"
echo
