...
TOPOLOGY_FILE="${TOPOLOGY_FILE:-$REPO_ROOT/vendor/ub_topology_four_node_full_mesh.ini}"
...
SIM_UAPI_SCENARIO_CONFIG="${SIM_UAPI_SCENARIO_CONFIG:-$REPO_ROOT/scenarios/mvp_4host_single_domain.yaml}"
