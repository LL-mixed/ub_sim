...
ORCHESTRATION = {
	"source": str(_ROOT_DIR / "orchestration" / "final_rms.cpp"),
	"function_name": "aicpu_orchestration_entry"
}

KERNELS = [
	{"func_id": 0, "name": "final_rms_incore_0", "source": str(_ROOT_DIR / "kernels" / "aiv" / "final_rms_incore_0.cpp"), "core_type": "aiv"},
]
