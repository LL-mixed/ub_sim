...
__global__ AICORE void final_rms_incore_0(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3) {
  ...
  for (size_t v28 = v22; v28 < v23; v28 += v21) {
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v35 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v5 + v5 * (unsigned) v13 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v28) * (uint32_t) v8) * (unsigned) v12), v33, v34);
  ...
  for (size_t v76 = v22; v76 < v23; v76 += v21) {
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v84 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v5 + v5 * (unsigned) v13 + (unsigned) v77 * (unsigned) v12), v82, v83);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND> v95 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND>(v3 + (v5 + v5 * (unsigned) v13 + (unsigned) v77 * (unsigned) v12), v93, v94);
    TLOAD(v90, v95);
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v110 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v2 + (v5 + v5 * (unsigned) v13 + (unsigned) v77 * (unsigned) v12), v108, v109);
