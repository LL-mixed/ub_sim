// Kernel Function: final_rms_incore_0
...
static __aicore__ void final_rms_incore_0(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ Tensor* out__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[1]);
    __gm__ bfloat16_t* out__ssa_v0 = reinterpret_cast<__gm__ bfloat16_t*>(out__ssa_v0_tensor->buffer.addr) + out__ssa_v0_tensor->start_offset;
    ...
    final_rms_incore_0(x__ssa_v0, out__ssa_v0, gamma__ssa_v0);
}
