...
static __aicore__ void q_proj(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4, int32_t v5, int32_t v6) {
  unsigned v7 = 0;
  const int32_t v8 = 10;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    q_proj(q_proj__iter_v3, normed_tile__rv_v2, wq__ssa_v0, ob_chunk__idx_v0, layer_hidden_base__ssa_v0, b0__idx_v0);
}
