...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ Tensor* current_hidden__rv_v7_tensor = reinterpret_cast<__gm__ Tensor*>(args[1]);
    ...
    copy_out(out__iter_v1, current_hidden__rv_v7, b0__idx_v0, cur_valid__ssa_v3, USER_BATCH_DYN);
}
