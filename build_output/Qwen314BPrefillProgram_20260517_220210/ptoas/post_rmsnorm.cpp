...
__global__ AICORE void post_rmsnorm(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ float* v3) {
  ...
  for (size_t v29 = v23; v29 < v24; v29 += v22) {
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND> v36 = GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND>(v1 + (v5 + v5 * (unsigned) v13 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v29) * (uint32_t) v8) * (unsigned) v12), v34, v35);
  ...
  for (size_t v85 = v23; v85 < v24; v85 += v22) {
    ...
    pto::Stride<327680, 327680, 327680, 5120, 1> v92 = pto::Stride<327680, 327680, 327680, 5120, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND> v93 = GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND>(v1 + (v5 + v5 * (unsigned) v13 + (unsigned) v86 * (unsigned) v12), v91, v92);
    ...
    pto::Stride<5120, 5120, 5120, 5120, 1> v99 = pto::Stride<5120, 5120, 5120, 5120, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND> v100 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND>(v3 + (v5 + v5 * (unsigned) v13 + (unsigned) v86 * (unsigned) v12), v98, v99);
    TLOAD(v95, v100);
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND> v115 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<327680, 327680, 327680, 5120, 1>, pto::Layout::ND>(v2 + (v5 + v5 * (unsigned) v13 + (unsigned) v86 * (unsigned) v12), v113, v114);
