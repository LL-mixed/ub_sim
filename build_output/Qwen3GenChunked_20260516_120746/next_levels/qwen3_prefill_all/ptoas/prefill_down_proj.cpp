...
__global__ AICORE void prefill_down_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5) {
  ...
  pto::Stride<196608, 196608, 196608, 3072, 1> v21 = pto::Stride<196608, 196608, 196608, 3072, 1>();
  GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<196608, 196608, 196608, 3072, 1>, pto::Layout::ND> v22 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<196608, 196608, 196608, 3072, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v11 + v6 * (unsigned) v10), v20, v21);
  ...
  GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<131072, 131072, 131072, 1024, 1>, pto::Layout::ND> v29 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<131072, 131072, 131072, 1024, 1>, pto::Layout::ND>(v2 + (v6 + (unsigned) v4 * (unsigned) v9 + (unsigned) v5 * (unsigned) v10), v27, v28);
  TLOAD(v24, v29);
  ...
  for (size_t v42 = v15; v42 < ((size_t) v7); v42 += v15) {
    ...
    pto::Stride<196608, 196608, 196608, 3072, 1> v49 = pto::Stride<196608, 196608, 196608, 3072, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<196608, 196608, 196608, 3072, 1>, pto::Layout::ND> v50 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<196608, 196608, 196608, 3072, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v11 + (unsigned) v43 * (unsigned) v10), v48, v49);
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<131072, 131072, 131072, 1024, 1>, pto::Layout::ND> v57 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<131072, 131072, 131072, 1024, 1>, pto::Layout::ND>(v2 + (v6 + (unsigned) ((int32_t) (uint32_t) v4 + (uint32_t) v43) * (unsigned) v9 + (unsigned) v5 * (unsigned) v10), v55, v56);
