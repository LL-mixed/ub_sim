...
__global__ AICORE void prefill_softmax(__gm__ float* v1, __gm__ float* v2, __gm__ bfloat16_t* v3, __gm__ float* v4, int32_t v5, int32_t v6, int32_t v7) {
  ...
  for (size_t v24 = (size_t) v14; v24 < ((size_t) v13); v24 += (size_t) v16) {
    int32_t v25 = (int32_t) ((uint32_t) ((int32_t) (uint32_t) v5 * (uint32_t) v13) + (uint32_t) ((int32_t) v24));
    __gm__ float* v26;
    __gm__ float* v27;
    ...
    if (v25 < v6) {
      ...
      pto::Shape<1, 1, 1, 2, -1> v37 = pto::Shape<1, 1, 1, 2, -1>(v30);
      pto::Stride<512, 512, 512, 256, 1> v38 = pto::Stride<512, 512, 512, 256, 1>();
      GlobalTensor<float, pto::Shape<1, 1, 1, 2, -1>, pto::Stride<512, 512, 512, 256, 1>, pto::Layout::ND> v39 = GlobalTensor<float, pto::Shape<1, 1, 1, 2, -1>, pto::Stride<512, 512, 512, 256, 1>, pto::Layout::ND>(v4 + (v9 + (unsigned) v35 * (unsigned) v15 + v9 * (unsigned) v16), v37, v38);
