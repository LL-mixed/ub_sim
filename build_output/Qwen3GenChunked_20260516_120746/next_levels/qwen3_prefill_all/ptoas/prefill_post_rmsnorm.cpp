...
__global__ AICORE void prefill_post_rmsnorm(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4) {
  ...
  for (size_t v30 = v24; v30 < v25; v30 += v23) {
    ...
    pto::Stride<65536, 65536, 65536, 1024, 1> v36 = pto::Stride<65536, 65536, 65536, 1024, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND> v37 = GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v30) * (uint32_t) v9) * (unsigned) v13), v35, v36);
  ...
  for (size_t v86 = v24; v86 < v25; v86 += v23) {
    ...
    pto::Stride<65536, 65536, 65536, 1024, 1> v93 = pto::Stride<65536, 65536, 65536, 1024, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND> v94 = GlobalTensor<float, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + (unsigned) v87 * (unsigned) v13), v92, v93);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND> v101 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND>(v3 + (v6 + (unsigned) v4 * (unsigned) v14 + (unsigned) v87 * (unsigned) v13), v99, v100);
    TLOAD(v96, v101);
    ...
    pto::Stride<65536, 65536, 65536, 1024, 1> v115 = pto::Stride<65536, 65536, 65536, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND> v116 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND>(v2 + (v6 + v6 * (unsigned) v14 + (unsigned) v87 * (unsigned) v13), v114, v115);
