...
__global__ AICORE void prefill_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6, int32_t v7, int32_t v8) {
  ...
  unsigned v10 = 0;
  const int32_t v11 = 524288;
  const float v12 = 9.99999997E-7f;
  const float v13 = 9.765625E-4f;
  ...
  TEXPANDS(v32, v17);
  for (size_t v35 = v29; v35 < v30; v35 += v28) {
    ...
    pto::Stride<524288, 524288, 524288, 1024, 1> v42 = pto::Stride<524288, 524288, 524288, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND> v43 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND>(v1 + ((v10 + (unsigned) v4 * (unsigned) v11) + (unsigned) v5 * (unsigned) v20 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v35) * (uint32_t) v14) * (unsigned) v19), v41, v42);
  ...
  for (size_t v100 = v29; v100 < v30; v100 += v28) {
    ...
    pto::Stride<524288, 524288, 524288, 1024, 1> v108 = pto::Stride<524288, 524288, 524288, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND> v109 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND>(v1 + ((v10 + (unsigned) v4 * (unsigned) v11) + (unsigned) v5 * (unsigned) v20 + (unsigned) v101 * (unsigned) v19), v107, v108);
    ...
    pto::Stride<1024, 1024, 1024, 1024, 1> v123 = pto::Stride<1024, 1024, 1024, 1024, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND> v124 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND>(v3 + (v10 + (unsigned) v7 * (unsigned) v20 + (unsigned) v101 * (unsigned) v19), v122, v123);
    TLOAD(v119, v124);
    ...
    pto::Stride<65536, 65536, 65536, 1024, 1> v138 = pto::Stride<65536, 65536, 65536, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND> v139 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND>(v2 + (v10 + v10 * (unsigned) v20 + (unsigned) v101 * (unsigned) v19), v137, v138);
