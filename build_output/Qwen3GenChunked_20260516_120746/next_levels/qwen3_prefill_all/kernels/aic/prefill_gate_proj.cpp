// Kernel Function: prefill_gate_proj
...
static __aicore__ void prefill_gate_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5) {
  unsigned v6 = 0;
  const int32_t v7 = 8;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    o0__ssa_v1_conv.u64 = args[4];
    int64_t o0__ssa_v1 = o0__ssa_v1_conv.val;

    // Forward to ptoas-generated function
    prefill_gate_proj(post_norm_tile__rv_v2, w_gate__ssa_v0, ret0__out, layer_off_h__ssa_v0, o0__ssa_v1);
}
