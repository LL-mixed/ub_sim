// Kernel Function: prefill_down_proj
...
static __aicore__ void prefill_down_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5) {
  unsigned v6 = 0;
  const int32_t v7 = 24;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    prefill_down_proj(mlp_silu_tile__rv_v2, w_down__ssa_v0, ret0__out, layer_off_inter__ssa_v0, d0__ssa_v0);
}
