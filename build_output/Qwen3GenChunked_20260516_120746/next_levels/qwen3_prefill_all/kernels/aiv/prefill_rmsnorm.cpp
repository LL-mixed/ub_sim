// Kernel Function: prefill_rmsnorm
...
static __aicore__ void prefill_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6, int32_t v7, int32_t v8) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    layer_idx__idx_v0_conv.u64 = args[6];
    ...
    prefill_rmsnorm(current_hidden__iter_v8, normed_tile__ssa_v0, input_rms_weight__ssa_v0, b__idx_v0, p0__ssa_v1, valid_tok__ssa_v0, layer_idx__idx_v0, user_batch__ssa_v0);
}
