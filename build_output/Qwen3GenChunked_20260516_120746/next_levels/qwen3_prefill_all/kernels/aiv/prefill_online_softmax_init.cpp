// Kernel Function: prefill_online_softmax_init
...
static __aicore__ void prefill_online_softmax_init(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3) {
  unsigned v4 = 0;
  const float v5 = 0.0f;
  const int32_t v6 = 1;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ Tensor* ret1__out_tensor = reinterpret_cast<__gm__ Tensor*>(args[1]);
    ...
    __gm__ Tensor* ret2__out_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* ret2__out = reinterpret_cast<__gm__ float*>(ret2__out_tensor->buffer.addr) + ret2__out_tensor->start_offset;

    // Forward to ptoas-generated function
    prefill_online_softmax_init(ret0__out, ret1__out, ret2__out);
}
