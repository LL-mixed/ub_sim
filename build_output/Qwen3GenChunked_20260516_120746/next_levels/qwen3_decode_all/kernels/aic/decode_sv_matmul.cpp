// Kernel Function: decode_sv_matmul
...
static __aicore__ void decode_sv_matmul(__gm__ float* v1, __gm__ int32_t* v2, __gm__ bfloat16_t* v3, __gm__ bfloat16_t* v4, int32_t v5, int32_t v6, int32_t v7, int32_t v8, int32_t v9, int32_t v10, int32_t v11, int32_t v12) {
  unsigned v13 = 0;
  const int32_t v14 = 2;
...
{
    // Unpack tensor: all_oi_tmp__co_l0_iter_v3
    __gm__ Tensor* all_oi_tmp__co_l0_iter_v3_tensor = reinterpret_cast<__gm__ Tensor*>(args[0]);
    __gm__ float* all_oi_tmp__co_l0_iter_v3 = reinterpret_cast<__gm__ float*>(all_oi_tmp__co_l0_iter_v3_tensor->buffer.addr) + all_oi_tmp__co_l0_iter_v3_tensor->start_offset;
    ...
    // Unpack tensor: v_cache_all__co_l0_rv_v5
    __gm__ Tensor* v_cache_all__co_l0_rv_v5_tensor = reinterpret_cast<__gm__ Tensor*>(args[3]);
    __gm__ bfloat16_t* v_cache_all__co_l0_rv_v5 = reinterpret_cast<__gm__ bfloat16_t*>(v_cache_all__co_l0_rv_v5_tensor->buffer.addr) + v_cache_all__co_l0_rv_v5_tensor->start_offset;
    ...
    // Unpack scalar: kvh__ssa_v1
    union { uint64_t u64; int64_t val; } kvh__ssa_v1_conv;
    kvh__ssa_v1_conv.u64 = args[7];
    int64_t kvh__ssa_v1 = kvh__ssa_v1_conv.val;

    // Unpack scalar: gi__idx_v0
    union { uint64_t u64; int64_t val; } gi__idx_v0_conv;
    gi__idx_v0_conv.u64 = args[8];
    ...
    layer_off_cache__ssa_v0_conv.u64 = args[9];
    ...
    int64_t KV_CACHE_ROWS_ALL_DYN = static_cast<int64_t>(v_cache_all__co_l0_rv_v5_tensor->shapes[0]);

    // Forward to ptoas-generated function
    decode_sv_matmul(all_oi_tmp__co_l0_iter_v3, block_table__ssa_v0, all_exp_padded__rv_v2, v_cache_all__co_l0_rv_v5, sb__co_idx_v0, ctx_blocks__ssa_v0, block_table_base__ssa_v0, kvh__ssa_v1, gi__idx_v0, layer_off_cache__ssa_v0, BLOCK_TABLE_FLAT_DYN, KV_CACHE_ROWS_ALL_DYN);
}
