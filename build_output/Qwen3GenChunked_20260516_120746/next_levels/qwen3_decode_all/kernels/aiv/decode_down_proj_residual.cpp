// Kernel Function: decode_down_proj_residual
...
static __aicore__ void decode_down_proj_residual(__gm__ float* v1, __gm__ float* v2, __gm__ bfloat16_t* v3, int32_t v4, int32_t v5) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ bfloat16_t* next_hidden__iter_v3 = reinterpret_cast<__gm__ bfloat16_t*>(next_hidden__iter_v3_tensor->buffer.addr) + next_hidden__iter_v3_tensor->start_offset;
    ...
    decode_down_proj_residual(fp32_chunk_gm__ssa_v1, resid1_tile__rv_v2, next_hidden__iter_v3, d0__ssa_v0, b0__idx_v0);
}
