// Kernel Function: decode_rmsnorm
...
static __aicore__ void decode_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    layer_idx__idx_v0_conv.u64 = args[5];
    int64_t layer_idx__idx_v0 = layer_idx__idx_v0_conv.val;

    // Forward to ptoas-generated function
    decode_rmsnorm(current_hidden__iter_v6, normed_tile__ssa_v0, input_rms_weight__ssa_v0, b0__idx_v0, cur_valid__ssa_v1, layer_idx__idx_v0);
}
