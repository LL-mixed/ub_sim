...
static __aicore__ void decode_silu(__gm__ float* v1, __gm__ float* v2, __gm__ bfloat16_t* v3) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    decode_silu(gate_acc__rv_v2, up_acc__rv_v2, ret0__out);
}
