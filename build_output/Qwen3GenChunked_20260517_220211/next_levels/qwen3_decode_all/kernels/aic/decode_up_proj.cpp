// Kernel Function: decode_up_proj
...
static __aicore__ void decode_up_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5) {
  unsigned v6 = 0;
  const int32_t v7 = 40;
  const int32_t v8 = 64;
  const int32_t v9 = 0;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    decode_up_proj(post_norm_tile__rv_v2, w_up__ssa_v0, ret0__out, layer_off_h__ssa_v0, o0__ssa_v1);
}
