...
__global__ AICORE void decode_post_rmsnorm(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4) {
  ...
  for (size_t v30 = v25; v30 < v24; v30 += v23) {
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v37 = GlobalTensor<float, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v30) * (uint32_t) v9) * (unsigned) v13), v35, v36);
  ...
  for (size_t v74 = v25; v74 < v24; v74 += v23) {
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v82 = GlobalTensor<float, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + (unsigned) v75 * (unsigned) v13), v80, v81);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND> v89 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND>(v3 + (v6 + (unsigned) v4 * (unsigned) v14 + (unsigned) v75 * (unsigned) v13), v87, v88);
    TLOAD(v84, v89);
    ...
    pto::Stride<81920, 81920, 81920, 5120, 1> v107 = pto::Stride<81920, 81920, 81920, 5120, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v108 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v2 + (v6 + v6 * (unsigned) v14 + (unsigned) v75 * (unsigned) v13), v106, v107);
