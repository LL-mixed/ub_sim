...
__global__ AICORE void decode_silu(__gm__ float* v1, __gm__ float* v2, __gm__ bfloat16_t* v3) {
  ...
  pto::Stride<278528, 278528, 278528, 17408, 1> v59 = pto::Stride<278528, 278528, 278528, 17408, 1>();
  GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 256>, pto::Stride<278528, 278528, 278528, 17408, 1>, pto::Layout::ND> v60 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 256>, pto::Stride<278528, 278528, 278528, 17408, 1>, pto::Layout::ND>(v3 + (v5 + v5 * (unsigned) v7 + v5 * (unsigned) v8), v58, v59);
