...
__global__ AICORE void decode_gate_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5) {
  unsigned v6 = 0;
  const int32_t v7 = 40;
  const int32_t v8 = 64;
  const int32_t v9 = 0;
  ...
  GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v27 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + v6 * (unsigned) v13), v25, v26);
  ...
  pto::Stride<2228224, 2228224, 2228224, 17408, 1> v33 = pto::Stride<2228224, 2228224, 2228224, 17408, 1>();
  GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 256>, pto::Stride<2228224, 2228224, 2228224, 17408, 1>, pto::Layout::ND> v34 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 256>, pto::Stride<2228224, 2228224, 2228224, 17408, 1>, pto::Layout::ND>(v2 + (v6 + (unsigned) v4 * (unsigned) v12 + (unsigned) v5 * (unsigned) v13), v32, v33);
  TLOAD(v29, v34);
  ...
  for (size_t v59 = v20; v59 < ((size_t) v7); v59 += v20) {
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v67 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v1 + (v6 + v6 * (unsigned) v14 + (unsigned) v60 * (unsigned) v13), v65, v66);
    ...
    pto::Stride<2228224, 2228224, 2228224, 17408, 1> v73 = pto::Stride<2228224, 2228224, 2228224, 17408, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 256>, pto::Stride<2228224, 2228224, 2228224, 17408, 1>, pto::Layout::ND> v74 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 128, 256>, pto::Stride<2228224, 2228224, 2228224, 17408, 1>, pto::Layout::ND>(v2 + (v6 + (unsigned) ((int32_t) (uint32_t) v4 + (uint32_t) v60) * (unsigned) v12 + (unsigned) v5 * (unsigned) v13), v72, v73);
