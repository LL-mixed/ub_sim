...
__global__ AICORE void decode_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6) {
  ...
  for (size_t v34 = v28; v34 < v29; v34 += v27) {
    ...
    pto::Stride<-1, -1, -1, 5120, 1> v41 = pto::Stride<-1, -1, -1, 5120, 1>(v39, v39, v39);
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 512>, pto::Stride<-1, -1, -1, 5120, 1>, pto::Layout::ND> v42 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 512>, pto::Stride<-1, -1, -1, 5120, 1>, pto::Layout::ND>(v1 + (v9 + (unsigned) v4 * (unsigned) v17 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v34) * (uint32_t) v12) * (unsigned) v16), v40, v41);
  ...
  for (size_t v95 = v28; v95 < v29; v95 += v27) {
    ...
    pto::Stride<-1, -1, -1, 5120, 1> v103 = pto::Stride<-1, -1, -1, 5120, 1>(v101, v101, v101);
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 512>, pto::Stride<-1, -1, -1, 5120, 1>, pto::Layout::ND> v104 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 512>, pto::Stride<-1, -1, -1, 5120, 1>, pto::Layout::ND>(v1 + (v9 + (unsigned) v4 * (unsigned) v17 + (unsigned) v96 * (unsigned) v16), v102, v103);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND> v115 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<5120, 5120, 5120, 5120, 1>, pto::Layout::ND>(v3 + (v9 + (unsigned) v6 * (unsigned) v17 + (unsigned) v96 * (unsigned) v16), v113, v114);
    ...
    pto::Stride<81920, 81920, 81920, 5120, 1> v129 = pto::Stride<81920, 81920, 81920, 5120, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 512>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v130 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 512>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(v2 + (v9 + v9 * (unsigned) v17 + (unsigned) v96 * (unsigned) v16), v128, v129);
