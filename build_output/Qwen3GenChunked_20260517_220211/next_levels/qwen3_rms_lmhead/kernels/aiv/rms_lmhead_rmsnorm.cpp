// Kernel Function: rms_lmhead_rmsnorm
...
static __aicore__ void rms_lmhead_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3) {
...
{
    // Unpack tensor: x__ssa_v0
    __gm__ Tensor* x__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[0]);
    __gm__ bfloat16_t* x__ssa_v0 = reinterpret_cast<__gm__ bfloat16_t*>(x__ssa_v0_tensor->buffer.addr) + x__ssa_v0_tensor->start_offset;

    // Unpack tensor: rms_normed__ssa_v0
    __gm__ Tensor* rms_normed__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[1]);
    __gm__ bfloat16_t* rms_normed__ssa_v0 = reinterpret_cast<__gm__ bfloat16_t*>(rms_normed__ssa_v0_tensor->buffer.addr) + rms_normed__ssa_v0_tensor->start_offset;

    // Unpack tensor: gamma__ssa_v0
    __gm__ Tensor* gamma__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    ...
    rms_lmhead_rmsnorm(x__ssa_v0, rms_normed__ssa_v0, gamma__ssa_v0);
}
