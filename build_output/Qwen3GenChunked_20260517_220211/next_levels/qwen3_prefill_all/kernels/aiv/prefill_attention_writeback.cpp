// Kernel Function: prefill_attention_writeback
...
static __aicore__ void prefill_attention_writeback(__gm__ bfloat16_t* v1, __gm__ float* v2, int32_t v3) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    prefill_attention_writeback(attn_row__iter_v1, ctx_tmp__ssa_v1, q_base__ssa_v1);
}
