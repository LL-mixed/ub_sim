// Kernel Function: prefill_sv_matmul
...
static __aicore__ void prefill_sv_matmul(__gm__ float* v1, __gm__ int32_t* v2, __gm__ bfloat16_t* v3, __gm__ bfloat16_t* v4, int32_t v5, int32_t v6, int32_t v7, int32_t v8, int32_t v9, int32_t v10, int32_t v11) {
  unsigned v12 = 0;
...
{
    // Unpack tensor: all_oi_tmp__co_l0_iter_v1
    __gm__ Tensor* all_oi_tmp__co_l0_iter_v1_tensor = reinterpret_cast<__gm__ Tensor*>(args[0]);
    __gm__ float* all_oi_tmp__co_l0_iter_v1 = reinterpret_cast<__gm__ float*>(all_oi_tmp__co_l0_iter_v1_tensor->buffer.addr) + all_oi_tmp__co_l0_iter_v1_tensor->start_offset;
    ...
    // Unpack tensor: all_exp_padded__co_l0_rv_v1
    __gm__ Tensor* all_exp_padded__co_l0_rv_v1_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ bfloat16_t* all_exp_padded__co_l0_rv_v1 = reinterpret_cast<__gm__ bfloat16_t*>(all_exp_padded__co_l0_rv_v1_tensor->buffer.addr) + all_exp_padded__co_l0_rv_v1_tensor->start_offset;

    // Unpack tensor: v_cache_all__co_l0_rv_v9
    __gm__ Tensor* v_cache_all__co_l0_rv_v9_tensor = reinterpret_cast<__gm__ Tensor*>(args[3]);
    __gm__ bfloat16_t* v_cache_all__co_l0_rv_v9 = reinterpret_cast<__gm__ bfloat16_t*>(v_cache_all__co_l0_rv_v9_tensor->buffer.addr) + v_cache_all__co_l0_rv_v9_tensor->start_offset;
    ...
    int64_t KV_CACHE_ROWS_ALL_DYN = static_cast<int64_t>(v_cache_all__co_l0_rv_v9_tensor->shapes[0]);

    // Forward to ptoas-generated function
    prefill_sv_matmul(all_oi_tmp__co_l0_iter_v1, block_table__ssa_v0, all_exp_padded__co_l0_rv_v1, v_cache_all__co_l0_rv_v9, sb__co_idx_v0, ctx_blocks__ssa_v0, b__idx_v0, kvh__ssa_v0, layer_off_cache__ssa_v0, BLOCK_TABLE_FLAT_DYN, KV_CACHE_ROWS_ALL_DYN);
}
