...
static __aicore__ void final_rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    final_rmsnorm(x__ssa_v0, out__ssa_v0, gamma__ssa_v0);
}
