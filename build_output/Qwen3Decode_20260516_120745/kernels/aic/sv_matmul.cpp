...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ bfloat16_t* v_cache__rv_v6 = reinterpret_cast<__gm__ bfloat16_t*>(v_cache__rv_v6_tensor->buffer.addr) + v_cache__rv_v6_tensor->start_offset;
    ...
    layer_cache_base__ssa_v0_conv.u64 = args[7];
    ...
    sv_matmul(all_oi_tmp__iter_v1, block_table__ssa_v0, all_exp_padded__rv_v2, v_cache__rv_v6, sb_chunk__idx_v0, ctx_blocks__ssa_v0, block_table_base__ssa_v0, layer_cache_base__ssa_v0, BLOCK_TABLE_FLAT_DYN, KV_CACHE_ROWS_DYN);
}
