    ...
    PTO2_SCOPE() {
        ...
        for (int64_t layer_idx = 0; layer_idx < 28; layer_idx += 1) {
            PTO2_SCOPE() {
                ...
                int64_t layer_hidden_base = (layer_idx * 1024);
                int64_t layer_q_base = (layer_idx * 2048);
                int64_t layer_inter_base = (layer_idx * 3072);
                int64_t layer_cache_base = (layer_idx * 65536);
                for (int64_t b0 = 0; b0 < batch_padded; b0 += 16) {
                    PTO2_SCOPE() {
                        ...
                        for (int64_t ob_chunk = 0; ob_chunk < 32; ob_chunk += 4) {
                            PTO2_SCOPE() {
                                ...
                                params_t2.add_scalar(layer_hidden_base);
                        ...
                        for (int64_t ob_chunk = 0; ob_chunk < 16; ob_chunk += 4) {
                            PTO2_SCOPE() {
                                ...
                                params_t3.add_scalar(layer_hidden_base);
                ...
                for (int64_t b0 = 0; b0 < batch_padded; b0 += 16) {
                    PTO2_SCOPE() {
                        ...
                        params_t4.add_scalar(layer_idx);
                    ...
                    PTO2_SCOPE() {
                        ...
                        for (int64_t ki_chunk = 0; ki_chunk < 8; ki_chunk += 8) {
                            PTO2_SCOPE() {
                                ...
                                params_t6.add_scalar(layer_cache_base);
                        ...
                        for (int64_t sb_chunk = 0; sb_chunk < ctx_blocks; sb_chunk += 64) {
                            PTO2_SCOPE() {
                                ...
                                params_t7.add_scalar(layer_cache_base);
                        ...
                        for (int64_t sb_chunk = 0; sb_chunk < ctx_blocks; sb_chunk += 64) {
                            PTO2_SCOPE() {
                                ...
                                params_t9.add_scalar(layer_cache_base);
                    ...
                    PTO2_SCOPE() {
                        ...
                        for (int64_t ob = 0; ob < 16; ob += 1) {
                            PTO2_SCOPE() {
                                ...
                                params_t12.add_scalar(layer_q_base);
                        ...
                        for (int64_t ob = 0; ob < 12; ob += 1) {
                            PTO2_SCOPE() {
                                ...
                                params_t15.add_scalar(layer_hidden_base);
                                ...
                                params_t16.add_scalar(layer_hidden_base);
                        ...
                        for (int64_t dob = 0; dob < 8; dob += 1) {
                            PTO2_SCOPE() {
                                ...
                                params_t18.add_scalar(layer_inter_base);
