...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ Tensor* out__iter_v5_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    ...
    down_proj_residual(resid1_tile__rv_v2, down_acc__rv_v2, out__iter_v5, d0__ssa_v0, b__idx_v0, p0__ssa_v0, USER_BATCH_DYN);
}
