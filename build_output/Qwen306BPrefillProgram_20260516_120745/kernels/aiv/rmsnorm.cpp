...
static __aicore__ void rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6, int32_t v7) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    rmsnorm(hidden_states__ssa_v0, normed_tile__ssa_v0, input_rms_weight__ssa_v0, b__idx_v0, p0__ssa_v0, valid_tok__ssa_v0, USER_BATCH_DYN);
}
