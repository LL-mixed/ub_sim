// Kernel Function: online_softmax_init
...
static __aicore__ void online_softmax_init(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3) {
  unsigned v4 = 0;
  const float v5 = 0.0f;
  const int32_t v6 = 1;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    online_softmax_init(ret0__out, ret1__out, ret2__out);
}
