...
__global__ AICORE void rmsnorm(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int32_t v4, int32_t v5, int32_t v6, int32_t v7) {
  ...
  for (size_t v34 = v28; v34 < v29; v34 += v27) {
    ...
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND> v42 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND>(v1 + ((v9 + (unsigned) v4 * (unsigned) v10) + (unsigned) v5 * (unsigned) v19 + (unsigned) ((int32_t) (uint32_t) ((int32_t) v34) * (uint32_t) v13) * (unsigned) v18), v40, v41);
  ...
  for (size_t v99 = v28; v99 < v29; v99 += v27) {
    ...
    pto::Stride<524288, 524288, 524288, 1024, 1> v107 = pto::Stride<524288, 524288, 524288, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND> v108 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, -1, 128>, pto::Stride<524288, 524288, 524288, 1024, 1>, pto::Layout::ND>(v1 + ((v9 + (unsigned) v4 * (unsigned) v10) + (unsigned) v5 * (unsigned) v19 + (unsigned) v100 * (unsigned) v18), v106, v107);
    ...
    pto::Stride<1024, 1024, 1024, 1024, 1> v122 = pto::Stride<1024, 1024, 1024, 1024, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND> v123 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<1024, 1024, 1024, 1024, 1>, pto::Layout::ND>(v3 + (v9 + v9 * (unsigned) v19 + (unsigned) v100 * (unsigned) v18), v121, v122);
    TLOAD(v118, v123);
    ...
    pto::Stride<65536, 65536, 65536, 1024, 1> v137 = pto::Stride<65536, 65536, 65536, 1024, 1>();
    GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND> v138 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<65536, 65536, 65536, 1024, 1>, pto::Layout::ND>(v2 + (v9 + v9 * (unsigned) v19 + (unsigned) v100 * (unsigned) v18), v136, v137);
